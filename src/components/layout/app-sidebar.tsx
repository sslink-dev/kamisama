...
export function AppSidebar() {
  ...
  const renderItem = (item: { href: string; label: string; icon: typeof LayoutDashboard }) => {
    ...
    return (
      <Link
        key={item.href}
        href={item.href}
        className="group flex flex-col items-center gap-1 px-0.5 py-1.5 text-[10px] font-bold text-white"
      >
        <span
          className={cn(
  ...
  return (
    <>
      <aside className="fixed left-0 top-0 z-40 flex h-screen w-[88px] flex-col bg-[#F76FAB] py-4">
        ...
        {/* Divider */}
        <div className="mx-5 my-3 h-px bg-white/40" />
        ...
        <div className="px-1 pb-2">
          <button
            ...
            className="group flex w-full flex-col items-center gap-1 px-0.5 py-1.5 text-[10px] font-bold text-white"
          >
            ...
            <span className="whitespace-nowrap leading-tight">AIチャット</span>
          </button>
        </div>
        ...
        <div className="px-1">
          <form action="/auth/logout" method="post">
            ...
            >
              ...
              <span className="whitespace-nowrap leading-tight">ログアウト</span>
            </button>
          </form>
